...
// 해시태그 수정 버튼 클릭 시 팝업 표시
document.getElementById("modifyHashtagBtn").addEventListener("click", function () {
    document.getElementById("hashtagPopup").classList.add("active");
});
