...
@Controller("noticeFileDownload")
public class NoticeFileDownloadController extends HttpServlet {

    private static String ARTICLE_IMG_REPO = "D:\\yoni\\fileupload3";

    @RequestMapping("noticedownload.do")
    public void fileDown(@RequestParam("notice_id") long notice_id,
        ...
        String path = ARTICLE_IMG_REPO + "\\" + notice_id + "\\" + image_file_name; //이미지 경로, 이름
        ...
        FileInputStream fis = new FileInputStream(imageFiles); // imageFile 에는 경로가 있음
