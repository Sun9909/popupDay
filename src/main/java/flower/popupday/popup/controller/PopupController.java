...
public interface PopupController {
    ...
    public ModelAndView popupList(@RequestParam("id") Long id, @RequestParam("popup_id") Long popup_id, @RequestParam(value = "section", required = false) String _section, @RequestParam(value = "pageNum", required = false)
    String _pageNum, HttpServletRequest request, HttpServletResponse response) throws Exception;
}