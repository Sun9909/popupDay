...
public interface PopupDAO {
    ...
    //사업자 신청 팝업 리스트
    public List<PopupDTO> selectBsPopup(@Param("id") Long id, @Param("count") int count) throws DataAccessException;

    //사업자 신청 팝업 개수
    public int selectToBsPopup(@Param("id") Long id) throws DataAccessException;
}